...
$ bin/adminconsole sulu:build dev`,
  ...
  },
  {
    ...
    badges: [['accent', 'contributor'], ['success', 'active'], ['neutral', 'PHP']],
    body: 'I contribute to symfony/ai, the framework\'s AI integration: platform abstraction, agents, and store and RAG building blocks. Symfony Mate lives in the same monorepo. Ideas from Modelflow-AI are flowing into it, which is where that work continues now.',
